...
public class ModelAlien extends ModelBase {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.rightarm.rotateAngleX = MathHelper.cos(f * 0.6662f + (float)Math.PI) * 1.0f * f1 - 0.3490659f;
        this.leftarm.rotateAngleX = MathHelper.cos(f * 0.6662f) * 1.0f * f1 - 0.3490659f;
    }
}
