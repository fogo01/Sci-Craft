package com.fogo01.scicraft.render.dimensions;
...
public class SkyRenderer extends IRenderHandler {
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        f10 = 30.0F;
        mc.renderEngine.bindTexture(new ResourceLocation(Reference.MOD_ID + ":/textures/environment/MoonSun.png"));
        ...
        f10 = 40.0F;
        mc.renderEngine.bindTexture(new ResourceLocation(Reference.MOD_ID + ":/textures/environment/MoonEarth.png"));
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV((double)(-f10), -100.0D, (double)(f10), 0.0D, 0.0D);
        tessellator1.addVertexWithUV((double)f10, -100.0D, (double)(f10), 1.0D, 0.0D);
        tessellator1.addVertexWithUV((double)f10, -100.0D, (double)(-f10), 1.0D, 1.0D);
