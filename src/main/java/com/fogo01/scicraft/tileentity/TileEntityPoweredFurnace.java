...
public class TileEntityPoweredFurnace extends TileEntitySciCraftEnergy implements ISidedInventory {
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.localizedName : Names.Containers.CONTAINER_POWERED_FURNACE;
    }
